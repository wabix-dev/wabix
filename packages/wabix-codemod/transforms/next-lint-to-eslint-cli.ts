    ...
    if (
      ...
      node.arguments.forEach((arg: any) => {
        if (arg.type === 'Literal' || arg.type === 'StringLiteral') {
          if (arg.value === 'next') {
            needsNext = true
          } else if (arg.value === 'wabix/core-web-vitals') {
            needsNextVitals = true
          } else if (arg.value === 'wabix/typescript') {
            needsNextTs = true
              ...
              prop.value.elements?.forEach((element: any) => {
                if (
                  ...
                  if (element.value === 'next') {
                    needsNext = true
                  } else if (element.value === 'wabix/core-web-vitals') {
                    needsNextVitals = true
                  } else if (element.value === 'wabix/typescript') {
                    needsNextTs = true
