...
const program = new Command(packageJson.name)
  ...
  // to the main command "@wabix/codemod" even if it was passed after subcommands,
  // e.g. "@wabix/codemod upgrade --verbose" will be treated as "next-codemod --verbose upgrade"
