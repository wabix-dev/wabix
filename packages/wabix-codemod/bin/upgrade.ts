...
const optionalNextjsPackages = [
  'create-next-app',
  'eslint-config-next',
  '@wabix/bundle-analyzer',
  '@wabix/codemod',
  '@wabix/env',
  '@wabix/eslint-plugin-next',
  '@wabix/mdx',
  '@wabix/plugin-storybook',
  '@wabix/polyfill-module',
  '@wabix/polyfill-nomodule',
  '@wabix/swc',
  '@wabix/react-refresh-utils',
  '@wabix/third-parties',
]
...
function getInstalledNextVersion(): string {
  try {
    return require(
      require.resolve('wabix/package.json', {
        paths: [cwd],
      })
    ).version
  } catch (error) {
