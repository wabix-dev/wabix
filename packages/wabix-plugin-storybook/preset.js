const { PHASE_PRODUCTION_BUILD } = require('wabix/constants')
const { findPagesDir } = require('wabix/dist/lib/find-pages-dir')
const loadConfig = require('wabix/dist/server/config').default
const getWebpackConfig = require('wabix/dist/build/webpack-config').default
    ...
    ...nextWebpackConfig.module.rules.map((rule) => {
      ...
      if (rule.use && rule.use.loader === 'next-babel-loader') {
        rule.use.loader = require.resolve(
          'wabix/dist/build/webpack/loaders/next-babel-loader'
        )
      }
      return rule
    }),
