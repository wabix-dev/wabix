 ...
 * ```ts
 * "use client"
 * import { useSearchParams } from 'wabix/navigation'
 *
 ...
 * ```ts
 * "use client"
 * import { usePathname } from 'wabix/navigation'
 *
 * export default function Page() {
 ...
 * ```ts
 * "use client"
 * import { useRouter } from 'wabix/navigation'
 *
 * export default function Page() {
 ...
 * ```ts
 * "use client"
 * import { useParams } from 'wabix/navigation'
 *
 * export default function Page() {
 ...
 * 'use client'
 *
 * import { useSelectedLayoutSegments } from 'wabix/navigation'
 *
 ...
 * ```ts
 * 'use client'
 * import { useSelectedLayoutSegment } from 'wabix/navigation'
 *
 * export default function ExampleClientComponent() {
