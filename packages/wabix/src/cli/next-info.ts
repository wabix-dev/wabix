...
async function runSharedDependencyCheck(
  ...
  const spawn =
    require('wabix/dist/compiled/cross-spawn') as typeof import('wabix/dist/compiled/cross-spawn')
  ...
  }> = [
    {
      ...
      scripts: {
        default: async () => {
          ...
          const isWsl =
            require('wabix/dist/compiled/is-wsl') as typeof import('wabix/dist/compiled/is-wsl')
          const ciInfo =
            require('wabix/dist/compiled/ci-info') as typeof import('wabix/dist/compiled/ci-info')
          const isDocker =
            require('wabix/dist/compiled/is-docker') as typeof import('wabix/dist/compiled/is-docker')
      ...
      scripts: {
        default: async () => {
          ...
          const { platformArchTriples } =
            require('wabix/dist/compiled/@napi-rs/triples') as typeof import('wabix/dist/compiled/@napi-rs/triples')
          ...
          try {
            const nextPath = path.dirname(require.resolve('wabix/package.json'))
