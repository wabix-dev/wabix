...
import spawn from 'wabix/dist/compiled/cross-spawn'
 ...
 * You can access the default config by importing \`defaultPlaywrightConfig\` from \`'wabix/experimental/testmode/playwright'\`.
 */`
  return typescript
    ? `import { defineConfig } from 'wabix/experimental/testmode/playwright';\n\n${comment}\nexport default defineConfig({});`
    : `const { defineConfig } = require('wabix/experimental/testmode/playwright');\n\n${comment}\nmodule.exports = defineConfig({});`
}
