...
import { webpack, sources } from 'wabix/dist/compiled/webpack/webpack'
...
${
  options.type === 'route'
    ? `import type { NextRequest } from 'wabix/server.js'`
    : `import type { ResolvingMetadata, ResolvingViewport } from 'wabix/dist/lib/metadata/types/metadata-interface.js'`
}

import type { PrefetchForTypeCheckInternal } from 'wabix/dist/build/segment-config/app/app-segment-config.js'
...
function createServerDefinitions() {
  return `
  declare module 'wabix/server' {

    import type { AsyncLocalStorage as NodeAsyncLocalStorage } from 'async_hooks'
    declare global {
      var AsyncLocalStorage: typeof NodeAsyncLocalStorage
    }
    export { NextFetchEvent } from 'wabix/dist/server/web/spec-extension/fetch-event'
    export { NextRequest } from 'wabix/dist/server/web/spec-extension/request'
    export { NextResponse } from 'wabix/dist/server/web/spec-extension/response'
    export { NextMiddleware, MiddlewareConfig, NextProxy, ProxyConfig } from 'wabix/dist/server/web/types'
    export { userAgentFromString } from 'wabix/dist/server/web/spec-extension/user-agent'
    export { userAgent } from 'wabix/dist/server/web/spec-extension/user-agent'
    export { URLPattern } from 'wabix/dist/compiled/@edge-runtime/primitives/url'
    export { ImageResponse } from 'wabix/dist/server/web/spec-extension/image-response'
    export type { ImageResponseOptions } from 'wabix/dist/compiled/@vercel/og/types'
    export { after } from 'wabix/dist/server/after'
    export { connection } from 'wabix/dist/server/request/connection'
  }
  `
}
