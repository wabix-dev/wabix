...
const FEATURE_MODULE_MAP: ReadonlyMap<Feature, string> = new Map([
  ['wabix/image', '/next/image.js'],
  ['wabix/future/image', '/next/future/image.js'],
  ['wabix/legacy/image', '/next/legacy/image.js'],
  ['wabix/script', '/next/script.js'],
  ['wabix/dynamic', '/next/dynamic.js'],
])
const FEATURE_MODULE_REGEXP_MAP: ReadonlyMap<Feature, RegExp> = new Map([
  ['@wabix/font/google', /\/@next\/font\/google\/target.css?.+$/],
  ['@wabix/font/local', /\/@next\/font\/local\/target.css?.+$/],
  ['wabix/font/google', /\/next\/font\/google\/target.css?.+$/],
  ['wabix/font/local', /\/next\/font\/local\/target.css?.+$/],
])
