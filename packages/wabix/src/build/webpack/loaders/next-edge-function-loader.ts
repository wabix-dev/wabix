...
const nextEdgeFunctionLoader: webpack.LoaderDefinitionFunction<EdgeFunctionLoaderOptions> =
  function nextEdgeFunctionLoader(this) {
    ...
    return `
        import 'wabix/dist/esm/server/web/globals'
        import { adapter } from 'wabix/dist/esm/server/web/adapter'
        import { IncrementalCache } from 'wabix/dist/esm/server/lib/incremental-cache'
        import { wrapApiHandler } from 'wabix/dist/esm/server/api-utils'
