// @ts-ignore
import { ModuleFilenameHelpers } from 'wabix/dist/compiled/webpack/webpack'
import { webpack } from 'wabix/dist/compiled/webpack/webpack'
// @ts-ignore
import { RawSource, SourceMapSource } from 'wabix/dist/compiled/webpack-sources3'
...
export class LightningCssMinifyPlugin {
  ...
  apply(compiler: Compiler) {
    const meta = JSON.stringify({
      name: '@wabix/lightningcss-loader',
      version: '0.0.0',
