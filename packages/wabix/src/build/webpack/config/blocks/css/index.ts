import curry from 'wabix/dist/compiled/lodash.curry'
...
export const css = curry(async function css(
  ...
  const sassPreprocessors: webpack.RuleSetUseItem[] = [
    ...
    {
      loader: require.resolve('wabix/dist/compiled/sass-loader'),
      options: {
        implementation: sassImplementation,
  ...
  const googleLoader = require.resolve(
    'wabix/dist/compiled/@next/font/google/loader'
  )
  const localLoader = require.resolve(
    'wabix/dist/compiled/@next/font/local/loader'
  )
  const nextFontLoaders: Array<[string | RegExp, string, any?]> = [
    [require.resolve('wabix/font/google/target.css'), googleLoader],
    [require.resolve('wabix/font/local/target.css'), localLoader],
  ]
      ...
      loader({
        oneOf: [
          ...
          markRemovable({
            ...
            sideEffects: true,
            test: [regexCssGlobal, regexSassGlobal],
            use: require.resolve('wabix/dist/compiled/ignore-loader'),
          }),
        ].filter(nonNullable),
      })
    )
