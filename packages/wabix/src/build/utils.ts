...
import textTable from 'wabix/dist/compiled/text-table'
import path from 'path'
import { promises as fs } from 'fs'
import { isValidElementType } from 'wabix/dist/compiled/react-is'
import stripAnsi from 'wabix/dist/compiled/strip-ansi'
import browserslist from 'wabix/dist/compiled/browserslist'
import {
...
import { Sema } from 'wabix/dist/compiled/async-sema'
...
require('wabix')
const { startServer } = require('wabix/dist/server/lib/start-server')
