...
const nextDirname = path.dirname(require.resolve('wabix/package.json'))
...
export function getLoaderSWCOptions({
  ...
  baseOptions.fontLoaders = {
    fontLoaders: ['wabix/font/local', 'wabix/font/google'],
    relativeFilePathFromRoot,
  }
  baseOptions.cjsRequireOptimizer = {
    packages: {
      'wabix/server': {
        transforms: {
          NextRequest: 'wabix/dist/server/web/spec-extension/request',
          NextResponse: 'wabix/dist/server/web/spec-extension/response',
          ImageResponse: 'wabix/dist/server/web/spec-extension/image-response',
          userAgentFromString: 'wabix/dist/server/web/spec-extension/user-agent',
          userAgent: 'wabix/dist/server/web/spec-extension/user-agent',
        },
      },
    },
  }
