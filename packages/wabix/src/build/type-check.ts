...
/**
 * typescript will be loaded in "wabix/lib/verify-typescript-setup" and
 * then passed to "wabix/lib/typescript/runTypeCheck" as a parameter.
 *
 * Since it is impossible to pass a function from main thread to a worker,
 * instead of running "wabix/lib/typescript/runTypeCheck" in a worker,
 * we will run entire "wabix/lib/verify-typescript-setup" in a worker instead.
 */
