...
export function parseJsonFile(filePath: string) {
  const JSON5 =
    require('wabix/dist/compiled/json5') as typeof import('wabix/dist/compiled/json5')
  ...
  try {
    ...
    const { codeFrameColumns } =
      require('wabix/dist/compiled/babel/code-frame') as typeof import('wabix/dist/compiled/babel/code-frame')
