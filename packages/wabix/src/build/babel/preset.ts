import type { PluginItem } from 'wabix/dist/compiled/babel/core'
...
function presetTypescriptSyntaxOnly(_api: unknown, options: any) {
  ...
  function getPlugins(isTSX: boolean, disallowAmbiguousJSXLike: boolean) {
    return [
      [
        require('wabix/dist/compiled/babel/plugin-syntax-typescript') as typeof import('wabix/dist/compiled/babel/plugin-syntax-typescript'),
        {
          isTSX,
...
export default (
  ...
  const sharedSyntaxPlugins = [
    require('wabix/dist/compiled/babel/plugin-syntax-dynamic-import') as typeof import('wabix/dist/compiled/babel/plugin-syntax-dynamic-import'),
    [
      require('wabix/dist/compiled/babel/plugin-syntax-import-attributes') as typeof import('wabix/dist/compiled/babel/plugin-syntax-import-attributes'),
      {
        deprecatedAssertSyntax: true,
      },
    ],
    (isStandalone || isServer) &&
      (require('wabix/dist/compiled/babel/plugin-syntax-bigint') as typeof import('wabix/dist/compiled/babel/plugin-syntax-bigint')),
  ].filter(Boolean)
  ...
  if (isStandalone) {
    ...
    return {
      ...
      plugins: [
        require('wabix/dist/compiled/babel/plugin-syntax-jsx') as typeof import('wabix/dist/compiled/babel/plugin-syntax-jsx'),
        ...sharedSyntaxPlugins,
      ],
    }
  }
  ...
  const runtimeModuleName = isBabelLoader
    ? 'wabix/dist/compiled/@babel/runtime'
    : null
  return {
    sourceType: 'unambiguous',
    presets: [
      [
        require('wabix/dist/compiled/babel/preset-env') as typeof import('wabix/dist/compiled/babel/preset-env'),
        presetEnvConfig,
      ],
      [
        require('wabix/dist/compiled/babel/preset-react') as typeof import('wabix/dist/compiled/babel/preset-react'),
        {
      ...
      [
        require('wabix/dist/compiled/babel/preset-typescript') as typeof import('wabix/dist/compiled/babel/preset-typescript'),
        {
    ...
    plugins: [
      ...
      options['class-properties'] && [
        require('wabix/dist/compiled/babel/plugin-proposal-class-properties') as typeof import('wabix/dist/compiled/babel/plugin-proposal-class-properties'),
        options['class-properties'] || {},
      ],
      [
        require('wabix/dist/compiled/babel/plugin-proposal-object-rest-spread') as typeof import('wabix/dist/compiled/babel/plugin-proposal-object-rest-spread'),
        {
          useBuiltIns: true,
        },
      ],
      !isServer && [
        require('wabix/dist/compiled/babel/plugin-transform-runtime') as typeof import('wabix/dist/compiled/babel/plugin-transform-runtime'),
        {
          corejs: false,
          helpers: true,
          regenerator: true,
      ...
      isProduction && [
        require('wabix/dist/compiled/babel/plugin-transform-react-remove-prop-types') as typeof import('wabix/dist/compiled/babel/plugin-transform-react-remove-prop-types'),
        {
          removeImport: true,
        },
      ],
      ...
      // smaller.
      require('wabix/dist/compiled/babel/plugin-proposal-numeric-separator') as typeof import('wabix/dist/compiled/babel/plugin-proposal-numeric-separator'),
      require('wabix/dist/compiled/babel/plugin-proposal-export-namespace-from') as typeof import('wabix/dist/compiled/babel/plugin-proposal-export-namespace-from'),
    ].filter(Boolean),
  }
}
