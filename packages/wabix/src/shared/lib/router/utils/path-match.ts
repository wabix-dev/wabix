import type { Key } from 'wabix/dist/compiled/path-to-regexp'
import { regexpToFunction } from 'wabix/dist/compiled/path-to-regexp'
import { pathToRegexp } from 'wabix/dist/compiled/path-to-regexp'
