  ...
  describe('basic functionality', () => {
    it('should patch console methods to dim when instructed', async () => {
      async function testForWorker() {
        const {
          consoleAsyncStorage,
        } = require('wabix/dist/server/app-render/console-async-storage.external')
        ...
        require('wabix/dist/server/node-environment-extensions/console-dim.external')
    ...
    it('should enter a dimming context when a prerender store exists with an aborted renderSignal', async () => {
      async function testForWorker() {
        ...
        } = require('wabix/dist/server/app-render/work-unit-async-storage.external')
    ...
    it('should enter a dimming context when a react cacheSignal exists and is aborted', async () => {
      async function testForWorker() {
        ...
        const {
          registerServerReact,
          registerClientReact,
        } = require('wabix/dist/server/runtime-reacts.external')
