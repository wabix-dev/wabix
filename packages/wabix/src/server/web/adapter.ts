...
import type { TextMapGetter } from 'wabix/dist/compiled/@opentelemetry/api'
  ...
  if (!testApisIntercepted) {
    ...
    if (process.env.NEXT_PRIVATE_TEST_PROXY === 'true') {
      const { interceptTestApis, wrapRequestHandler } =
        ...
        require('wabix/dist/experimental/testmode/server-edge') as typeof import('../../experimental/testmode/server-edge')
      interceptTestApis()
