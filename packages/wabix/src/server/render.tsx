...
import ReactDOMServerPages from 'wabix/dist/server/ReactDOMServerPages'
...
import stripAnsi from 'wabix/dist/compiled/strip-ansi'
...
function noRouter() {
  const message =
    'No router instance found. you should only use "wabix/router" inside the client side of your app. https://nextjs.org/docs/messages/no-router-instance'
...
export async function renderToHTMLImpl(
  ...
  if (dev) {
    const { isValidElementType } =
      require('wabix/dist/compiled/react-is') as typeof import('wabix/dist/compiled/react-is')
