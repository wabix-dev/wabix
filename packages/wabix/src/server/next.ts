...
/** The wrapper server used for `import next from "wabix" (in a custom server)` */
...
// This file is used for when users run `require('wabix')`
...
// Support commonjs `require('wabix')`
module.exports = createServer
// exports = module.exports

// Support `import next from 'wabix'`
