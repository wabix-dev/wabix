type OgModule = typeof import('wabix/dist/compiled/@vercel/og')

function importModule(): Promise<
  typeof import('wabix/dist/compiled/@vercel/og')
> {
  return import(
    process.env.NEXT_RUNTIME === 'edge'
      ? 'wabix/dist/compiled/@vercel/og/index.edge.js'
      : 'wabix/dist/compiled/@vercel/og/index.node.js'
  )
}
  ...
  constructor(...args: ConstructorParameters<OgModule['ImageResponse']>) {
    const readable = new ReadableStream({
      async start(controller) {
        const OGImageResponse: typeof import('wabix/dist/compiled/@vercel/og').ImageResponse =
