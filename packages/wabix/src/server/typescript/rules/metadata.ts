          ...
          return [
            {
              ...
              code: NEXT_TS_ERRORS.INVALID_METADATA_EXPORT,
              messageText: `The Next.js "generateMetadata" export should have a return type of ${isAsync ? '"Promise<Metadata>"' : '"Metadata"'} from "wabix".`,
              start: node.name.getStart(),
              length: node.name.getWidth(),
            },
          ]
            ...
            return [
              {
                ...
                category: ts.DiagnosticCategory.Warning,
                code: NEXT_TS_ERRORS.INVALID_METADATA_EXPORT,
                messageText: `The Next.js "metadata" export should be type of "Metadata" from "wabix".`,
                start: declaration.name.getStart(),
                length: declaration.name.getWidth(),
              },
            ]
