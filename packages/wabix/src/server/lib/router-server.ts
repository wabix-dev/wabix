...
import setupDebug from 'wabix/dist/compiled/debug'
...
import setupCompression from 'wabix/dist/compiled/compression'
...
export async function initialize(opts: {
  ...
  if (config.experimental.testProxy) {
    ...
    const { wrapRequestHandlerWorker, interceptTestApis } =
      ...
      require('wabix/dist/experimental/testmode/server') as typeof import('../../experimental/testmode/server')
