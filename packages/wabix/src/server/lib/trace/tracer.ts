...
import type {
  ...
  AttributeValue,
  TextMapGetter,
} from 'wabix/dist/compiled/@opentelemetry/api'
import { isThenable } from '../../../shared/lib/is-thenable'

const NEXT_OTEL_PERFORMANCE_PREFIX = process.env.NEXT_OTEL_PERFORMANCE_PREFIX

let api: typeof import('wabix/dist/compiled/@opentelemetry/api')
...
if (process.env.NEXT_RUNTIME === 'edge') {
  ...
  try {
    ...
    api =
      require('wabix/dist/compiled/@opentelemetry/api') as typeof import('wabix/dist/compiled/@opentelemetry/api')
  }
}
