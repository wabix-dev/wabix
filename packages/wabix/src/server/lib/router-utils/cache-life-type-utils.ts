...
declare module 'wabix/cache' {
  export { unstable_cache } from 'wabix/dist/server/web/spec-extension/unstable-cache'
  export {
    updateTag,
    revalidateTag,
    revalidatePath,
    refresh,
  } from 'wabix/dist/server/web/spec-extension/revalidate'
  export { unstable_noStore } from 'wabix/dist/server/web/spec-extension/unstable-no-store'

  ${overloads}

  import { cacheTag } from 'wabix/dist/server/use-cache/cache-tag'
  export { cacheTag }
