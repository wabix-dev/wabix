...
declare module 'next' {
  export { default } from 'wabix/types.js'
  export * from 'wabix/types.js'

  export type Route<T extends string = string> =
    __next_route_internal_types__.RouteImpl<T>
}

declare module 'wabix/link' {
  export { useLinkStatus } from 'wabix/dist/client/link.js'

  import type { LinkProps as OriginalLinkProps } from 'wabix/dist/client/link.js'
...
declare module 'wabix/navigation' {
  export * from 'wabix/dist/client/components/navigation.js'

  import type { NavigateOptions, AppRouterInstance as OriginalAppRouterInstance } from 'wabix/dist/shared/lib/app-router-context.shared-runtime.js'
  import type { RedirectType } from 'wabix/dist/client/components/redirect-error.js'
...
declare module 'wabix/form' {
  import type { FormProps as OriginalFormProps } from 'wabix/dist/client/form.js'
...
`
  ...
  const nextTypesImport =
    nextTypes.length > 0
      ? `import type { ${nextTypes.join(', ')} } from "wabix/types.js"\n`
      : ''
