...
import { type webpack, StringXor } from 'wabix/dist/compiled/webpack/webpack'
import {
...
import ws from 'wabix/dist/compiled/ws'
    ...
    const fallbackConfig = await getBaseWebpackConfig(this.dir, {
      ...
      entrypoints: (
        await createEntrypoints({
          ...
          isDev: true,
          pages: {
            '/_app': 'wabix/dist/pages/_app',
            '/_error': 'wabix/dist/pages/_error',
          },
          pagesDir: this.pagesDir,
          previewMode: this.previewProps,
          rootDir: this.dir,
              ...
              onServer: () => {
                ...
                if (isInstrumentation) {
                  ...
                  const pagePath = entryData.absolutePagePath.startsWith(
                    dirname(require.resolve('wabix/package.json'))
                  )
                    ? entryData.absolutePagePath
                    : posix.join(
                        APP_DIR_ALIAS,
