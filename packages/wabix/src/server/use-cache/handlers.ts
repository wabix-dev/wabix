...
const handlersSymbol = Symbol.for('@wabix/cache-handlers')
const handlersMapSymbol = Symbol.for('@wabix/cache-handlers-map')
const handlersSetSymbol = Symbol.for('@wabix/cache-handlers-set')
