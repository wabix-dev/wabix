...
import type { CookieSerializeOptions } from 'wabix/dist/compiled/cookie'

import bytes from 'wabix/dist/compiled/bytes'
...
function setDraftMode<T>(
  ...
  const { serialize } =
    require('wabix/dist/compiled/cookie') as typeof import('wabix/dist/compiled/cookie')
...
function setPreviewData<T>(
  ...
  const jsonwebtoken =
    require('wabix/dist/compiled/jsonwebtoken') as typeof import('wabix/dist/compiled/jsonwebtoken')
