...
export async function next__polyfill_nomodule(task, opts) {
  await task
    .source(relative(__dirname, require.resolve('@wabix/polyfill-nomodule')))
    .target('dist/build/polyfills')
}

export async function next__polyfill_module(task, opts) {
  await task
    .source(relative(__dirname, require.resolve('@wabix/polyfill-module')))
    .target('dist/build/polyfills')
}
...
const externals = {
  ...
  'postcss-safe-parser': 'wabix/dist/compiled/postcss-safe-parser',
  ...
  'terser-webpack-plugin':
    'wabix/dist/build/webpack/plugins/terser-webpack-plugin/src',

  punycode: 'punycode/',
  // TODO: Add @swc/helpers to externals once @vercel/ncc switch to swc-loader
}
externals['node-html-parser'] = 'wabix/dist/compiled/node-html-parser'
...
externals['@vercel/routing-utils'] = 'wabix/dist/compiled/@vercel/routing-utils'
...
externals['busboy'] = 'wabix/dist/compiled/busboy'
...
externals['@babel/runtime'] = 'wabix/dist/compiled/@babel/runtime'
  ...
  for (const file of runtimeFiles) {
    ...
    if (inputPath.endsWith('.js')) {
      contents = contents
        .replace(
          'regenerator-runtime',
          'wabix/dist/compiled/regenerator-runtime'
        )
        .replace('@babel/runtime', 'wabix/dist/compiled/@babel/runtime')
    }
...
externals['@vercel/og'] = 'wabix/dist/compiled/@vercel/og'
export async function copy_vercel_og(task, opts) {
  ...
  await task
    ...
    .run({ every: true }, function* (file) {
      ...
      file.data = source
        .replace(/['"]satori['"]/g, '"wabix/dist/compiled/@vercel/og/satori"')
...
externals['anser'] = 'wabix/dist/compiled/anser'
externals['wabix/dist/compiled/anser'] = 'wabix/dist/compiled/anser'
...
externals['stacktrace-parser'] = 'wabix/dist/compiled/stacktrace-parser'
externals['wabix/dist/compiled/stacktrace-parser'] =
  'wabix/dist/compiled/stacktrace-parser'
...
externals['data-uri-to-buffer'] = 'wabix/dist/compiled/data-uri-to-buffer'
externals['wabix/dist/compiled/data-uri-to-buffer'] =
  'wabix/dist/compiled/data-uri-to-buffer'
...
externals['css.escape'] = 'wabix/dist/compiled/css.escape'
externals['wabix/dist/compiled/css.escape'] = 'wabix/dist/compiled/css.escape'
...
externals['shell-quote'] = 'wabix/dist/compiled/shell-quote'
externals['wabix/dist/compiled/shell-quote'] = 'wabix/dist/compiled/shell-quote'
...
externals['acorn'] = 'wabix/dist/compiled/acorn'
...
externals['@edge-runtime/cookies'] = 'wabix/dist/compiled/@edge-runtime/cookies'
...
externals['@edge-runtime/primitives'] =
  'wabix/dist/compiled/@edge-runtime/primitives'
...
externals['edge-runtime'] = 'wabix/dist/compiled/edge-runtime'
export async function ncc_edge_runtime(task, opts) {
  ...
  await fs.writeFile(
    ...
    content.replace(
      ...
      `__non_webpack_require__.resolve('wabix/dist/compiled/@edge-runtime/primitives`
    )
  )
...
export async function ncc_next_font(task, opts) {
  ...
  const destDir = join(__dirname, 'dist/compiled/@wabix/font')
  const pkgPath = require.resolve('@wabix/font/package.json')
...
externals['watchpack'] = 'wabix/dist/compiled/watchpack'
...
externals['jest-worker'] = 'wabix/dist/compiled/jest-worker'
...
export async function ncc_react_refresh_utils(task, opts) {
  ...
  const srcDir = join(
    dirname(require.resolve('@wabix/react-refresh-utils/package.json')),
    'dist'
  )
  const destDir = join(
    __dirname,
    'dist/compiled/@wabix/react-refresh-utils/dist'
  )
  await rmrf(destDir)
  await fs.mkdir(destDir, { recursive: true })
  ...
  for (const file of files) {
    ...
    await fs.writeFile(
      ...
      content.replace(
        ...
        'wabix/dist/compiled/react-refresh/runtime'
      )
    )
  }
}

externals['browserslist'] = 'wabix/dist/compiled/browserslist'
...
externals['@napi-rs/triples'] = 'wabix/dist/compiled/@napi-rs/triples'
...
externals['p-limit'] = 'wabix/dist/compiled/p-limit'
...
externals['p-queue'] = 'wabix/dist/compiled/p-queue'
...
externals['raw-body'] = 'wabix/dist/compiled/raw-body'
...
externals['image-size'] = 'wabix/dist/compiled/image-size'
...
externals['image-detector'] = 'wabix/dist/compiled/image-detector'
...
externals['@hapi/accept'] = 'wabix/dist/compiled/@hapi/accept'
...
externals['async-retry'] = 'wabix/dist/compiled/async-retry'
...
externals['async-sema'] = 'wabix/dist/compiled/async-sema'
...
externals['postcss-plugin-stub-for-cssnano-simple'] =
  'wabix/dist/compiled/postcss-plugin-stub-for-cssnano-simple'
...
const babelCorePackages = {
  'code-frame': 'wabix/dist/compiled/babel/code-frame',
  '@babel/generator': 'wabix/dist/compiled/babel/generator',
  '@babel/traverse': 'wabix/dist/compiled/babel/traverse',
  '@babel/types': 'wabix/dist/compiled/babel/types',
  '@babel/core': 'wabix/dist/compiled/babel/core',
  '@babel/parser': 'wabix/dist/compiled/babel/parser',
  '@babel/core/lib/config': 'wabix/dist/compiled/babel/core-lib-config',
  '@babel/core/lib/transformation/normalize-file':
    'wabix/dist/compiled/babel/core-lib-normalize-config',
  '@babel/core/lib/transformation/normalize-opts':
    'wabix/dist/compiled/babel/core-lib-normalize-opts',
  '@babel/core/lib/transformation/block-hoist-plugin':
    'wabix/dist/compiled/babel/core-lib-block-hoisting-plugin',
  '@babel/core/lib/transformation/plugin-pass':
    'wabix/dist/compiled/babel/core-lib-plugin-pass',
}
externals['wabix/dist/compiled/babel/code-frame'] =
  'wabix/dist/compiled/babel/code-frame'
...
export async function ncc_babel_bundle(task, opts) {
  const bundleExternals = {
    ...externals,
    'wabix/dist/compiled/babel-packages': 'wabix/dist/compiled/babel-packages',
  }
...
externals['cssnano-simple'] = 'wabix/dist/compiled/cssnano-simple'
export async function ncc_cssnano_simple_bundle(task, opts) {
  const bundleExternals = {
    ...externals,
    'postcss-svgo': 'wabix/dist/compiled/postcss-plugin-stub-for-cssnano-simple',
  }
...
externals['bytes'] = 'wabix/dist/compiled/bytes'
...
externals['ci-info'] = 'wabix/dist/compiled/ci-info'
...
externals['cli-select'] = 'wabix/dist/compiled/cli-select'
...
externals['commander'] = 'wabix/dist/compiled/commander'
...
externals['comment-json'] = 'wabix/dist/compiled/comment-json'
...
externals['compression'] = 'wabix/dist/compiled/compression'
...
externals['conf'] = 'wabix/dist/compiled/conf'
...
externals['content-disposition'] = 'wabix/dist/compiled/content-disposition'
...
externals['content-type'] = 'wabix/dist/compiled/content-type'
...
externals['cookie'] = 'wabix/dist/compiled/cookie'
...
externals['cross-spawn'] = 'wabix/dist/compiled/cross-spawn'
...
externals['debug'] = 'wabix/dist/compiled/debug'
...
externals['devalue'] = 'wabix/dist/compiled/devalue'
...
externals['find-up'] = 'wabix/dist/compiled/find-up'
...
externals['fresh'] = 'wabix/dist/compiled/fresh'
...
externals['glob'] = 'wabix/dist/compiled/glob'
...
externals['gzip-size'] = 'wabix/dist/compiled/gzip-size'
...
externals['http-proxy'] = 'wabix/dist/compiled/http-proxy'
...
externals['ignore-loader'] = 'wabix/dist/compiled/ignore-loader'
...
externals['is-animated'] = 'wabix/dist/compiled/is-animated'
...
externals['ipaddr.js'] = 'wabix/dist/compiled/ipaddr.js'
...
externals['is-docker'] = 'wabix/dist/compiled/is-docker'
...
externals['is-wsl'] = 'wabix/dist/compiled/is-wsl'
...
externals['json5'] = 'wabix/dist/compiled/json5'
...
externals['jsonwebtoken'] = 'wabix/dist/compiled/jsonwebtoken'
export async function ncc_jsonwebtoken(task, opts) {
  await task
    ...
    .ncc({
      ...
      externals: {
        ...externals,
        semver: 'wabix/dist/lib/semver-noop',
      },
    })
    .target('src/compiled/jsonwebtoken')
}
externals['loader-runner'] = 'wabix/dist/compiled/loader-runner'
...
externals['loader-utils2'] = 'wabix/dist/compiled/loader-utils2'
...
externals['loader-utils3'] = 'wabix/dist/compiled/loader-utils3'
...
externals['lodash.curry'] = 'wabix/dist/compiled/lodash.curry'
...
externals['lru-cache'] = 'wabix/dist/compiled/lru-cache'
...
externals['nanoid'] = 'wabix/dist/compiled/nanoid'
...
externals['native-url'] = 'wabix/dist/compiled/native-url'
export async function ncc_native_url(task, opts) {
  await task
    ...
    .ncc({
      ...
      externals: {
        ...externals,
        querystring: 'wabix/dist/compiled/querystring-es3',
      },
      target: 'es5',
    })
    .target('src/compiled/native-url')
}
externals['neo-async'] = 'wabix/dist/compiled/neo-async'
...
externals['ora'] = 'wabix/dist/compiled/ora'
...
externals['postcss-flexbugs-fixes'] =
  'wabix/dist/compiled/postcss-flexbugs-fixes'
...
externals['postcss-preset-env'] = 'wabix/dist/compiled/postcss-preset-env'
...
externals['postcss-scss'] = 'wabix/dist/compiled/postcss-scss'
...
externals['postcss-modules-extract-imports'] =
  'wabix/dist/compiled/postcss-modules-extract-imports'
...
externals['postcss-modules-local-by-default'] =
  'wabix/dist/compiled/postcss-modules-local-by-default'
...
externals['postcss-modules-scope'] = 'wabix/dist/compiled/postcss-modules-scope'
...
externals['postcss-modules-values'] =
  'wabix/dist/compiled/postcss-modules-values'
...
externals['postcss-value-parser'] = 'wabix/dist/compiled/postcss-value-parser'
...
externals['icss-utils'] = 'wabix/dist/compiled/icss-utils'
...
externals['scheduler'] = 'wabix/dist/compiled/scheduler-experimental'
externals['scheduler'] = 'wabix/dist/compiled/scheduler'
  ...
  function* copy_vendor_react_impl(task, opts) {
    ...
    function aliasVendoredReactPackages(source) {
      return source
        .replace(
          /require\(["']react["']\)/g,
          `require("wabix/dist/compiled/react${packageSuffix}")`
        )
        .replace(
          /require\(["']react-dom["']\)/g,
          `require("wabix/dist/compiled/react-dom${packageSuffix}")`
        )
        .replace(
          /require\(["']scheduler["']\)/g,
          `require("wabix/dist/compiled/scheduler${packageSuffix}")`
        )
    }
...
externals['sass-loader'] = 'wabix/dist/compiled/sass-loader'
...
externals['schema-utils2'] = 'wabix/dist/compiled/schema-utils2'
...
externals['schema-utils3'] = 'wabix/dist/compiled/schema-utils3'
...
externals['semver'] = 'wabix/dist/compiled/semver'
...
externals['send'] = 'wabix/dist/compiled/send'
...
externals['source-map'] = 'wabix/dist/compiled/source-map'
...
// NB: Used by other dependencies, but Vercel version is a duplicate
// version so can be inlined anyway (although may change in future)
externals['source-map08'] = 'wabix/dist/compiled/source-map08'
externals['wabix/dist/compiled/source-map08'] = 'wabix/dist/compiled/source-map08'
...
externals['serve-handler'] = 'wabix/dist/compiled/serve-handler'
...
externals['string-hash'] = 'wabix/dist/compiled/string-hash'
...
externals['strip-ansi'] = 'wabix/dist/compiled/strip-ansi'
externals['wabix/dist/compiled/strip-ansi'] = 'wabix/dist/compiled/strip-ansi'
...
externals['@vercel/nft'] = 'wabix/dist/compiled/@vercel/nft'
...
externals['tar'] = 'wabix/dist/compiled/tar'
...
externals['terser'] = 'wabix/dist/compiled/terser'
...
externals['text-table'] = 'wabix/dist/compiled/text-table'
...
externals['unistore'] = 'wabix/dist/compiled/unistore'
...
externals['superstruct'] = 'wabix/dist/compiled/superstruct'
...
externals['zod'] = 'wabix/dist/compiled/zod'
...
externals['zod-validation-error'] = 'wabix/dist/compiled/zod-validation-error'
...
externals['web-vitals'] = 'wabix/dist/compiled/web-vitals'
...
externals['web-vitals-attribution'] =
  'wabix/dist/compiled/web-vitals-attribution'
...
externals['webpack-sources1'] = 'wabix/dist/compiled/webpack-sources1'
...
externals['webpack-sources3'] = 'wabix/dist/compiled/webpack-sources3'
...
externals['picomatch'] = 'wabix/dist/compiled/picomatch'
...
externals['mini-css-extract-plugin'] =
  'wabix/dist/compiled/mini-css-extract-plugin'
  ...
  await task
    ...
    .ncc({
      externals: {
        ...externals,
        './hmr': './hmr',
        'schema-utils': 'wabix/dist/compiled/schema-utils3',
      },
    })
...
externals['ua-parser-js'] = 'wabix/dist/compiled/ua-parser-js'
...
externals['ws'] = 'wabix/dist/compiled/ws'
...
externals['path-to-regexp'] = 'wabix/dist/compiled/path-to-regexp'
...
externals['@opentelemetry/api'] = 'wabix/dist/compiled/@opentelemetry/api'
...
externals['http-proxy-agent'] = 'wabix/dist/compiled/http-proxy-agent'
...
externals['https-proxy-agent'] = 'wabix/dist/compiled/https-proxy-agent'
...
externals['safe-stable-stringify'] = 'wabix/dist/compiled/safe-stable-stringify'
