...
const CHANGE_ITEM_GROUPS = {
  docs: [
    ...
    'packages/wabix-plugin-storybook/readme.md',
    'packages/wabix/license.md',
    'packages/wabix/README.md',
    'packages/eslint-plugin-next/README.md',
    'packages/wabix-codemod/license.md',
    'packages/wabix-codemod/README.md',
    'crates/wasm/README.md',
    'packages/wabix-swc/README.md',
    'packages/wabix-bundle-analyzer/readme.md',
    'packages/wabix-mdx/license.md',
    'packages/wabix-mdx/readme.md',
    ...
    'packages/wabix-env/README.md',
    'packages/wabix/src/client/components/react-dev-overlay/README.md',
  ],
  ...
  'next-codemod': ['packages/wabix-codemod'],
  'next-swc': [
    'packages/wabix-swc',
