...
export default globalIgnores([
  ...
  'packages/wabix/src/bundles/webpack/packages/*.runtime.js',
  'packages/wabix/src/bundles/webpack/packages/lazy-compilation-*.js',
  'packages/wabix/src/compiled/**/*',
  'packages/wabix/wasm/@next',
  'packages/react-refresh-utils/**/*.js',
  'packages/react-dev-overlay/lib/**/*',
  '**/__tmp__/**/*',
  '.github/actions/next-stats-action/.work',
  'packages/wabix-codemod/transforms/__testfixtures__/**/*',
  'packages/wabix-codemod/transforms/__tests__/**/*',
  'packages/wabix-codemod/bin/__testfixtures__/**/*',
  'packages/wabix-codemod/**/*.js',
  'packages/wabix-codemod/**/*.d.ts',
  'packages/wabix-env/**/*.d.ts',
  ...
  'packages/wabix-bundle-analyzer/index.d.ts',
  ...
  'packages/wabix-swc/docs/assets/**/*',
